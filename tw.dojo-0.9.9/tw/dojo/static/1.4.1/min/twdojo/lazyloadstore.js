dojo.provide("twdojo.LazyLoadStore");
dojo.require("dojo.data.ItemFileReadStore");

dojo.declare("twdojo.LazyLoadStore", dojo.data.ItemFileReadStore, {
	...
	loadItem: function(keywordArgs){
		...
		var dataUrl  = itemName;
		console.log(this)
		console.log(keywordArgs)
		while (parent != undefined){
			dataUrl = parent.name + "/"+dataUrl;
			break;
