...
execfile(os.path.join("sap", "release.py"))

packages = find_packages()
package_data = find_package_data(where='sap',
    package='sap')
...
setup(
    name="Sistema-de-Administracion-de-Proyectos",
    version=version,
    ...
    entry_points={
        'console_scripts': [
            'start-sap = sap.command:start',
            # See the sap.command.bootstrap function for details
